...
const GroupMembersDialog = ({ selectedConversation }: any) => {
	...
	const users = useQuery(api.user.getGroupMembers,  ChatDetails ? { conversationId: ChatDetails._id } : 'skip');
	return (
		<Dialog>
			<DialogTrigger>
