...
export const MessageReceivedSvg = (props: React.SVGProps<SVGSVGElement>) => (
	<svg width={16} height={11} fill='none' {...props}>
		<title>{"msg-dblcheck"}</title>
		<path
			fill='#34B7F1'
...
export const MessageSentSvg = (props: React.SVGProps<SVGSVGElement>) => (
	<svg width={16} height={16} viewBox="0 0 16 16" fill="none" {...props}>
	  <title>{"msg-singlecheck"}</title>
	  <path
		fill="currentColor"
		d="M13.854 2.146a.5.5 0 0 0-.708 0L6 9.793 4.354 8.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l7-7a.5.5 0 0 0 0-.708z"
	  />
	</svg>
  );
